...
VALUES 
  ...
  (2, "ADMIN"),
  (3, "EMPLOYEE");
INSERT INTO product (id_product, name, price, amount_available, category, producer, image_url)
VALUES
  (1, 'Resident Evil', 129.99, 5, 'HORROR', 'Capcom', 'https://picsum.photos/id/1/300'),
  (2, 'Call of Duty: Modern Warfare', 149.99, 10, 'FPS', 'Activision', 'https://picsum.photos/id/2/300'),
  (3, 'The Witcher 3: Wild Hunt', 139.99, 8, 'RPG', 'CD Projekt Red', 'https://picsum.photos/id/3/300'),
  (4, 'Silent Hill', 119.99, 3, 'HORROR', 'Konami', 'https://picsum.photos/id/4/300'),
  (5, 'Counter-Strike: Global Offensive', 114.99, 7, 'FPS', 'Valve', 'https://picsum.photos/id/5/300'),
  (6, 'Dark Souls III', 134.99, 6, 'RPG', 'Bandai Namco', 'https://picsum.photos/id/6/300'),
  (7, 'Dead Space', 124.99, 4, 'HORROR', 'Electronic Arts', 'https://picsum.photos/id/7/300'),
  (8, 'BioShock Infinite', 129.99, 5, 'FPS', '2K Games', 'https://picsum.photos/id/8/300'),
  (9, 'Divinity: Original Sin 2', 139.99, 8, 'RPG', 'Larian Studios', 'https://picsum.photos/id/9/300'),
  (10, 'Amnesia: The Dark Descent', 119.99, 3, 'HORROR', 'Frictional Games', 'https://picsum.photos/id/10/300'),
  (11, 'Half-Life 2', 19.99, 12, 'FPS', 'Valve', 'https://picsum.photos/id/11/300'),
  (12, 'Final Fantasy XV', 129.99, 5, 'RPG', 'Square Enix', 'https://picsum.photos/id/12/300'),
  (13, 'Outlast', 119.99, 3, 'HORROR', 'Red Barrels', 'https://picsum.photos/id/13/300'),
  (14, 'DOOM Eternal', 149.99, 10, 'FPS', 'Bethesda', 'https://picsum.photos/id/14/300'),
  (15, 'The Elder Scrolls V: Skyrim', 39.99, 8, 'RPG', 'Bethesda', 'https://picsum.photos/id/15/300'),
  (16, 'Dead by Daylight', 29.99, 5, 'HORROR', 'Behaviour Interactive', 'https://picsum.photos/id/16/300'),
  (17, 'Far Cry 5', 39.99, 8, 'FPS', 'Ubisoft', 'https://picsum.photos/id/17/300'),
  (18, 'Dark Souls', 119.99, 3, 'RPG', 'Bandai Namco', 'https://picsum.photos/id/18/300'),
  (19, 'Resident Evil 2 Remake', 29.99, 5, 'HORROR', 'Capcom', 'https://picsum.photos/id/19/300'),
  (20, 'Rainbow Six Siege', 29.99, 5, 'FPS', 'Ubisoft', 'https://picsum.photos/id/20/300'),
  (21, 'Divinity: Original Sin', 119.99, 3, 'RPG', 'Larian Studios', 'https://picsum.photos/id/21/300'),
  (22, 'Alien: Isolation', 24.99, 4, 'HORROR', 'SEGA', 'https://picsum.photos/id/22/300'),
  (23, 'Borderlands 2', 114.99, 7, 'FPS', '2K Games', 'https://picsum.photos/id/23/300'),
  (24, 'The Legend of Zelda: Breath of the Wild', 49.99, 10, 'RPG', 'Nintendo', 'https://picsum.photos/id/24/300'),
  (25, 'Resident Evil 7: Biohazard', 29.99, 5, 'HORROR', 'Capcom', 'https://picsum.photos/id/25/300'),
  (26, 'Dying Light', 24.99, 4, 'FPS', 'Techland', 'https://picsum.photos/id/26/300'),
  (27, 'Cyberpunk 2077', 159.99, 15, 'RPG', 'CD Projekt Red', 'https://picsum.photos/id/27/300'),
  (28, 'S.T.A.L.K.E.R.: Shadow of Chernobyl', 19.99, 3, 'HORROR', 'THQ', 'https://picsum.photos/id/28/300'),
  (29, 'Overwatch', 39.99, 8, 'FPS', 'Blizzard Entertainment', 'https://picsum.photos/id/29/300'),
  (30, 'Pillars of Eternity II: Deadfire', 34.99, 6, 'RPG', 'Obsidian Entertainment', 'https://picsum.photos/id/30/300'),
  (31, 'F.E.A.R.', 14.99, 7, 'HORROR', 'Warner Bros. Interactive Entertainment', 'https://picsum.photos/id/31/300'),
  (32, 'Team Fortress 2', 0.00, 20, 'FPS', 'Valve', 'https://picsum.photos/id/32/300'),
  (33, 'Kingdom Come: Deliverance', 29.99, 5, 'RPG', 'Warhorse Studios', 'https://picsum.photos/id/33/300'),
  (34, 'Layers of Fear', 119.99, 3, 'HORROR', 'Bloober Team', 'https://picsum.photos/id/34/300'),
  (35, 'Metro Exodus', 39.99, 8, 'FPS', 'Deep Silver', 'https://picsum.photos/id/35/300'),
  (36, 'Path of Exile', 0.00, 20, 'RPG', 'Grinding Gear Games', 'https://picsum.photos/id/36/300'),
  (37, 'Condemned: Criminal Origins', 9.99, 12, 'HORROR', 'Sega', 'https://picsum.photos/id/37/300'),
  (38, 'S.T.A.L.K.E.R.: Shadow of Chernobyl', 19.99, 3, 'HORROR', 'THQ', 'https://picsum.photos/id/38/300'),
  (39, 'Overwatch', 39.99, 8, 'FPS', 'Blizzard Entertainment', 'https://picsum.photos/id/39/300'),
  (40, 'Pillars of Eternity II: Deadfire', 34.99, 6, 'RPG', 'Obsidian Entertainment', 'https://picsum.photos/id/40/300'),
  (41, 'F.E.A.R.', 14.99, 7, 'HORROR', 'Warner Bros. Interactive Entertainment', 'https://picsum.photos/id/41/300'),
  (42, 'Team Fortress 2', 0.00, 20, 'FPS', 'Valve', 'https://picsum.photos/id/42/300'),
  (43, 'Kingdom Come: Deliverance', 29.99, 5, 'RPG', 'Warhorse Studios', 'https://picsum.photos/id/43/300'),
  (44, 'Layers of Fear', 119.99, 3, 'HORROR', 'Bloober Team', 'https://picsum.photos/id/44/300'),
  (45, 'Metro Exodus', 39.99, 8, 'FPS', 'Deep Silver', 'https://picsum.photos/id/45/300'),
  (46, 'Path of Exile', 0.00, 20, 'RPG', 'Grinding Gear Games', 'https://picsum.photos/id/46/300'),
  (47, 'Condemned: Criminal Origins', 9.99, 12, 'HORROR', 'Sega', 'https://picsum.photos/id/47/300'),
  (48, 'Bioshock', 14.99, 7, 'FPS', '2K Games', 'https://picsum.photos/id/48/300'),
  (49, 'Divinity: Original Sin Enhanced Edition', 24.99, 4, 'RPG', 'Larian Studios', 'https://picsum.photos/id/49/300'),
  (50, 'Outlast 2', 119.99, 3, 'HORROR', 'Red Barrels', 'https://picsum.photos/id/50/300');
